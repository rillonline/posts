...
# Blog Posts build configuration file, created by
# `ablog start` on Sat Aug 14 14:47:51 2021.
#
...
blog_title = "Notes to Myself"

# Base URL for the website, required for generating feeds.
# e.g. blog_baseurl = "http://example.com/"
blog_baseurl = "https://rillonline.github.io/posts"
...
blog_locations = {
   'Earth': ('The Blue Planet', 'https://en.wikipedia.org/wiki/Earth'),
     'Milwaukee': ('The Good Land', 'https://www.wisconsinhistory.org/Records/Article/CS1607'),
}
